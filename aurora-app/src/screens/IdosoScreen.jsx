...
export default function IdosoScreen() {
  ...
  // ── Falar com Aurora (toque para falar) ────────────────────────────────────

  const handleFalarComAurora = async () => {
    ...
    <SafeAreaView style={estilos.container}>
      <ScrollView contentContainerStyle={estilos.scroll}>
        ...
        <View style={estilos.cabecalho}>
          ...
          <Text style={estilos.subtitulo}>Aurora está aqui com você</Text>
          ...
          {respondendo ? (
            ...
            <>
              ...
              <Text style={estilos.vozTexto}>
                {vozAtiva ? 'Ouvindo...' : 'Falar com Aurora'}
              </Text>
            </>
          )}
        </TouchableOpacity>
